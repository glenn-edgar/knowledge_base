...
class Construct_KB:
    ...
    def leave_header_node(self, label, name):
        ...
        try:
            ...
            print(f"Error in leave_header_node: {e}")
            ...
            if self.conn and self.cursor:
                try:
                    ...
                    print(f"Error dropping knowledge_base table: {drop_error}")
                    if self.conn:
                        self.conn.rollback()
                ...
                try:
                    self._disconnect()
                    print("PostgreSQL connection terminated due to error.")
                except Exception as conn_error:
                    print(f"Error terminating PostgreSQL connection: {conn_error}")
